-- 创建系统根机构
insert into work_organ (id, parentId, name, status, ordinal, createUserId, createTime, updateUserId, updateTime)
...
-- 创建系统管理员工作人员
insert into work_worker (id, username, password, name, status, ordinal, defaultActorId, createUserId, createTime, updateUserId, updateTime)
...
-- 创建系统管理员角色
insert into work_role (id, name, privilegs, createUserId, createTime, updateUserId, updateTime)
...
-- 创建系统根机构管理员职务
insert into work_actor (id, organId, userId, roleId, name)
...
-- 创建普通用户默认角色身份
insert into visit_Identity (id, name, code, type, createUserId,createTime,updateUserId,updateTime)
values ('ADMINAID-0000-0000-0000-000000000000', '普通用户', 'default', '0', 'ADMINAID-0000-0000-0000-000000000000',NOW(),'ADMINAID-0000-0000-0000-000000000000',NOW());
